        ...
        <Container >
            ...
            <Container>
                <Row >
                    ...
                    <Col>
                        <a className="bottomIcons" id="resume" href="https://docs.google.com/document/d/1derMmx3P5p19w2RurNWZ1ZBbOSWU_UeQ7tJfaZKu0Os/export?format=pdf" style={{ color: '#00FFFF'}}><i className="fas fa-file-pdf fa-6x mt-2"></i></a>

                    </Col>
                    <Col>
                        <a href="tel:+1-646-853-1534"><i className="fas fa-mobile fa-6x bottomIcons mt-2" ></i></a>
                    </Col>
                </Row >
            </Container>
            <br />
